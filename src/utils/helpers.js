...
var retry = function (fn_1) {
    ...
    return __awaiter(void 0, __spreadArray([fn_1], args_1, true), void 0, function (fn, maxRetries, baseDelay) {
        var lastError, attempt, result, delayMs, error_1, delayMs;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, (0, exports.delay)(delayMs)];
                case 4:
                    _a.sent();
