...
exports.UppromoteDataExtractor = void 0;
var common_1 = require("@nestjs/common");
var base_data_extractor_1 = require("../base-data.extractor");
var uppromote_config_1 = require("../../configs/uppromote.config");
var UppromoteDataExtractor = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = base_data_extractor_1.BaseDataExtractor;
    var UppromoteDataExtractor = _classThis = /** @class */ (function (_super) {
        __extends(UppromoteDataExtractor_1, _super);
        function UppromoteDataExtractor_1(config) {
            var _this = _super.call(this, config) || this;
            _this.generalExtractors = _this.getExtractors(uppromote_config_1.uppromoteConfig.selectors.brandDetails.general);
            _this.offersExtractors = _this.getExtractors(uppromote_config_1.uppromoteConfig.selectors.brandDetails.offerDetails);
            return _this;
        }
        ...
        //   };
        // }
        UppromoteDataExtractor_1.prototype.extractText = function (page, selector) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, page.textContent(selector)];
                        case 1: return [2 /*return*/, (_a.sent()) || ''];
                    }
                });
            });
        };
        UppromoteDataExtractor_1.prototype.extractArray = function (page, selector) {
            return __awaiter(this, void 0, void 0, function () {
                var text;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.extractText(page, selector)];
                        case 1:
                            text = _a.sent();
                            return [2 /*return*/, this.parseArray(text)];
                    }
                });
            });
        };
        UppromoteDataExtractor_1.prototype.parseNumber = function (value) {
        ...
        UppromoteDataExtractor_1.prototype.parseArray = function (value) {
        ...
        return UppromoteDataExtractor_1;
    }(_classSuper));
    __setFunctionName(_classThis, "UppromoteDataExtractor");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        UppromoteDataExtractor = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UppromoteDataExtractor = _classThis;
}();
exports.UppromoteDataExtractor = UppromoteDataExtractor;
